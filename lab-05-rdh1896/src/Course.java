...
public class Course implements Comparable<Course> {
    ...
    public static void main(String[] args) {
        ...
        Iterator<Entry<Course, String>> iter = courseMap.entrySet().iterator();
        while (iter.hasNext()) {
            Map.Entry<Course, String> pair = (Map.Entry<Course,String>) iter.next();
            Course temp = pair.getKey();
